...
async def upload_file(
    ...
    if file.filename and file.filename.endswith(".json"):
        ...
        if isinstance(payload, dict):
            ...
            elif isinstance(payload.get("energy_records"), list):
                # Supports single-file bundle generated by scripts.generate_data.
                raw_records = payload["energy_records"]
            else:
                raw_records = []
        else:
            raw_records = payload
        ...
        payload = json.loads(text)
        if isinstance(payload, dict) and isinstance(payload.get("energy_records"), list):
            raw_records = payload["energy_records"]
    ...
    if not isinstance(raw_records, list):
        return ImportResult(
            ...
            errors=1,
            error_details=[
                "Invalid payload. Expected a JSON array, {'records': [...]}, or {'energy_records': [...]}.",
            ],
        )
